...
| global.notAppendXForwardedFor | string | `nil` | Disable appending RemoteAddr to X-Forwarded-For header globally (v3.7+). |
...
| ports.web.forwardedHeaders.notAppendXForwardedFor | string | `nil` | Disable appending RemoteAddr to X-Forwarded-For header (v3.7+). |
...
| ports.websecure.forwardedHeaders.notAppendXForwardedFor | string | `nil` | Disable appending RemoteAddr to X-Forwarded-For header (v3.7+). |
