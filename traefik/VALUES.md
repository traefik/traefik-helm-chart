...
![Version: 38.0.2](https://img.shields.io/badge/Version-38.0.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v3.6.6](https://img.shields.io/badge/AppVersion-v3.6.6-informational?style=flat-square)
...
| image.allowNonSupportedVersions | bool | `false` | Allow using non-supported versions (e.g. main-xxx, pr-xxx). This is intended for development purposes only. Use at your own risk. |
