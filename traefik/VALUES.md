...
| hub.apimanagement.admission.restartOnCertificateChange | bool | `true` | Set it to false if you want Traefik Hub pod to not be restarted on certificate change. Default: true. |
