...
| hub.apimanagement.admission.restartOnCertificateChange | bool | `true` | Set it to true if you want Traefik Hub pod to be restarted on certificate change. Default: true. |
