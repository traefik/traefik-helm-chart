...
* feat: add new options for traefik v3.7.11
* feat(deps): ✨ update traefik-hub to v3.20.11
* feat(deps): update traefik to v3.7.11 and traefik-hub to v3.20.10
* chore(release): 🚀 publish 41.3.0

### Default value changes

```diff
diff --git a/traefik/values.yaml b/traefik/values.yaml
index 86ab414..54a55eb 100644
--- a/traefik/values.yaml
+++ b/traefik/values.yaml
@@ -133,6 +133,8 @@ core:  # @schema additionalProperties: false
   ...
   defaultRuleSyntax: ""
+  # -- Disables the unsafe fallback to default TLS options on conflict, mitigating [GHSA-g55h-rg46-x9c5](https://github.com/traefik/traefik/security/advisories/GHSA-g55h-rg46-x9c5). Requires traefik v3.7.11+.
+  strictTLSOptions: false
 
 # Traefik experimental features
 experimental:
@@ -316,6 +318,8 @@ providers:
...
+    # -- Restricts the namespace where the cluster-wide TLSOption and TLSStore named `default` can be defined. When empty, any namespace is allowed. Requires traefik v3.7.11+.
...
@@ -324,6 +328,8 @@ providers:
     namespaces: []
     # -- Defines whether to use Native Kubernetes load-balancing mode by default.
     nativeLBByDefault: false
+    # -- Enables collision-safe naming. ⚠️ It can be breaking, see [upstream documentation](https://doc.traefik.io/traefik/reference/install-configuration/providers/kubernetes/kubernetes-crd/#safenaming). Requires traefik v3.7.11+.
+    safeNaming: false
...
## 41.1.0  ![AppVersion: v3.7.9](https://img.shields.io/static/v1?label=AppVersion&message=v3.7.9&color=success&logo=) ![Kubernetes: >=1.25.0-0](https://img.shields.io/static/v1?label=Kubernetes&message=%3E%3D1.25.0-0&color=informational&logo=kubernetes) ![Helm: v3](https://img.shields.io/static/v1?label=Helm&message=v3&color=informational&logo=helm)
...
* feat(deps): update traefik docker tag to v3.7.9
* feat(deps): update traefik docker tag to v3.7.8
* feat(deps): update traefik docker tag to v3.7.7
* feat(deps): update ghcr.io/traefik/traefik-hub docker tag to v3.20.7
* feat(CRDs): update Traefik Hub to v1.33.0
* docs: :books: change metrics.prometheus labels types from string to bool
* docs(values): :books: fix rendered types for nullable fields
* chore: :art: file provider scrambled output
...
@@ -208,11 +207,11 @@ api:  # @schema additionalProperties: false
   dashboard: true
...
+        # -- (bool) When set to true, the TLS connection accepts any certificate presented by the server regardless of the hostnames it covers.
     ...
     # -- Defines additional resource attributes to be sent to the collector.
     resourceAttributes: {}
@@ -830,7 +830,7 @@ tracing:  # @schema additionalProperties: false
...
@@ -850,7 +850,7 @@ tracing:  # @schema additionalProperties: false
         cert: ""
         # -- The path to the private key. When using this option, setting the cert option is required.
         key: ""
-        # -- When set to true, the TLS connection accepts any certificate presented by the server regardless of the hostnames it covers.
+        # -- (bool) When set to true, the TLS connection accepts any certificate presented by the server regardless of the hostnames it covers.
     ...
     grpc:
       # -- Set to true in order to send metrics to the OpenTelemetry Collector using gRPC
@@ -867,7 +867,7 @@ tracing:  # @schema additionalProperties: false
         cert: ""
         # -- The path to the private key. When using this option, setting the cert option is required.
         key: ""
-        # -- When set to true, the TLS connection accepts any certificate presented by the server regardless of the hostnames it covers.
...
+  # When set to false, it will create two Service, one for TCP and one for UDP.
   ...
   annotations: {}
@@ -1141,9 +1142,9 @@ autoscaling:  # @schema additionalProperties: false
...
+  # -- (int) maxReplicas is the upper limit for the number of pods that can be set by the autoscaler; cannot be smaller than MinReplicas.
   ...
   metrics: []
@@ -1280,12 +1281,19 @@ fullnameOverride: ""
...
@@ -1312,13 +1320,13 @@ hub:  # @schema additionalProperties: false
   mcpgateway:
     # -- Set to true in order to enable AI MCP Gateway. Requires a valid license token.
     enabled: false
...
@@ -1339,7 +1347,7 @@ hub:  # @schema additionalProperties: false
         address: ""
...
+        # -- (int) WaitTime limits how long a Watch will block. If not provided, the agent default
         ...
         httpauth:
           # -- Basic Auth password
@@ -1424,22 +1432,19 @@ hub:  # @schema additionalProperties: false
...
@@ -1515,10 +1520,10 @@ hub:  # @schema additionalProperties: false
...
@@ -1543,7 +1548,7 @@ hub:  # @schema additionalProperties: false
       key: ""
...
* feat(hub): :rocket: support traefik hub v3.20.1
* chore(release): 🚀 publish 40.0.1
