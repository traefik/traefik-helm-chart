    ...
    spec:
      ...
      - image: {{ template "traefik.image-name" . }}
        ...
        args:
          ...
          {{- end }}
          {{- if .Values.providers.kubernetesIngress.ingressEndpoint.hostname }}
          - "--providers.kubernetesingress.ingressendpoint.hostname={{ .Values.providers.kubernetesIngress.ingressEndpoint.hostname }}"
          {{- end }}
